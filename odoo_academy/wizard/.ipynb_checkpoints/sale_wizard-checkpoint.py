...
class SaleWizard(models.TransientModel):
    ...
    session_student_ids = fields.Many2many(comodel_name='res.partner', string='Student in Current Session', related='session_id.student_ids', 
                                          help='These are students currently in the session')
    student_ids = fields.Many2many(comodel_name='res.partner', string='Student to Sales Order')
